...
if (conf.LANG == 'ML') {
    ...
    already_off = 'കൃത്രിമബുദ് നിലവിൽ സെമി-ഫംഗ്ഷണൽ ആണ്.'
    succ_on = 'കൃത്രിമബുദ് പൂർണ്ണമായും പ്രവർത്തനക്ഷമമായി തുറന്നു! കുറച്ച് കാത്തിരിക്കൂ! ✅'
    succ_off = 'കൃത്രിമബുദ് സെമി-ഫങ്ഷണൽ ആയി സജ്ജമാക്കുക! കുറച്ച് കാത്തിരിക്കൂ! ☑️'
}
