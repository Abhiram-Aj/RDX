...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'ppitch', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
   ...
   Asena.addCommand({pattern: 'ownercmnd', fromMe: true, desc: 'set of commands for bot user or sudo'}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'pitch', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
