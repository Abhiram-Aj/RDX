...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    Asena.addCommand({pattern: 'asasashelp ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'asashelp ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {
