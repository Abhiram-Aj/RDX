...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to OXYMORON voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel OXYMORON özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'OXYMORON yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'OXYMORON yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'OXYMORON, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'OXYMORON, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional OXYMORON features. Turn your account into a ai chatbot!'
    already_on = 'OXYMORON artificial intelligence is already fully functional.'
    already_off = 'OXYMORON artificial intelligence is currently running semi-functional.'
    succ_on = 'OXYMORON Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'OXYMORON Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
