...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to RDX voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel RDX özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'RDX yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'RDX yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'RDX, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'RDX, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional RDX features. Turn your account into a ai chatbot!'
    already_on = 'RDX artificial intelligence is already fully functional.'
    already_off = 'RDX artificial intelligence is currently running semi-functional.'
    succ_on = 'RDX Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'RDX Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
