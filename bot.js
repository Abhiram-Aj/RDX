...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [ʟɪͥʏͭᴀᷤᴍᷟᴏͤʟ] --*' + 
                                    '\n*ʟɪͥʏͭᴀᷤᴍᷟᴏͤʟ an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [ʟɪͥʏͭᴀᷤᴍᷟᴏͤʟ] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
