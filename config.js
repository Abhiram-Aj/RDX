...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './Abhiram.db' : process.env.DATABASE_URL;
...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ʀᴅx' : process.env.ALL_CAPTION,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/King_as_ofc/' : process.env.SOCIAL_MEDIA,
    ...
    DATABASE: DATABASE_URL === './Abhiram.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
    RBG_API_KEY: process.env.REMOVE_BG_API_KEY === undefined ? false : process.env.REMOVE_BG_API_KEY,
    NO_ONLINE: process.env.NO_ONLINE === undefined ? true : convertToBool(process.env.NO_ONLINE),
    SUDO: process.env.SUDO === undefined ? '917736771516,0' : process.env.SUDO,
    DEBUG: DEBUG,
